...
public class PrintConstant {
    ...
    public static final String MENU_REQUEST = "기능을 선택하세요.";
    public static final String OPTION_CHOOSE_REQUEST = "%s을 선택하세요";
    public static final String OPTION_WITH_COMMA = "%s, %s, %s";
